...
use App\Job;
use App\JobCategory;
class JobsGrid extends BaseGrid
{	
	protected function setGrid(Grid $grid)
    {
        ...
        $grid->addColumn('applicants.id', 'Applicants')->setCallback(function ($var, $row) {
            $applicants = $row->getSrc()->applicants;
            return $applicants->count('id');
        });
