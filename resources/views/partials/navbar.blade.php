            ...
            @if(Auth::user()->role == 1)
             ...
             @if(Auth::user()->role == 2)
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="{{route('company-profile.show')}}">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="">MESSAGES</a>
                    </li> 
             ...
             @if(Auth::user()->role == 3)    
                 <ul class="navbar-nav mr-auto">
                     <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="/admin/jobseeker">JOBSEEKERS<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="/admin/company">CLIENTS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="/admin/jobs">JOBS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="/admin/categories">CATEGORIES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link list-group-item list-group-item-action flex-column align-items-end" href="/admin/skills">SKILLS</a>
                    </li>
                  </ul>                     
              @endif  
            @endguest      
